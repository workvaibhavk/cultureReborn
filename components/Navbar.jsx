      ...
      <div className="text-white flex justify-between w-8/12 mx-auto my-6 items-center navbar">
        ...
        {userData ? (
          <p>
            ...
            <Link
              href="/userarea"
              className=" text-2xl rounded-full text-black bg-white shadow-2xs p-6 size-12 mx-auto flex items-center justify-center "
            >
              {firstName.charAt(0) + lastName.charAt(0)}
            </Link>{" "}
          </p>
        ) : (
          <Link className="loginbtn" href="/authenticate">
            Join
          </Link>
        )}
